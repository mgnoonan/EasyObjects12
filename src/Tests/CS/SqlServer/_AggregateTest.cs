...
namespace NCI.EasyObjects.Tests.SQL
{
	...
	public class AggregateTestSchema : NCI.EasyObjects.Schema
	{
		...
		public static SchemaItem IsActive = new SchemaItem("IsActive", DbType.Boolean, false, true, false, false, false, false);
	...
	public abstract class _AggregateTest : EasyObject
	{
		...
		{	
			...
			switch(commandType)
			{
				...
				case CommandType.Text:
					...
					{
						dbCommandWrapper.AddInParameter("ID", DbType.Int32, "ID", DataRowVersion.Default);
					}
					else
					{
						dbCommandWrapper.AddParameter("ID", DbType.Int32, 0, ParameterDirection.Output, true, 0, 0, "ID", DataRowVersion.Default, Convert.DBNull);
		...
		private void CreateParameters(DBCommandWrapper dbCommandWrapper)
		{
			...
			dbCommandWrapper.AddParameter("ts", DbType.Binary, 8, ParameterDirection.InputOutput, false, 0, 0, "ts", DataRowVersion.Current, null);
		}
