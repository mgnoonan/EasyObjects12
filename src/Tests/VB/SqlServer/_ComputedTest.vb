...
Public MustInherit Class _ComputedTest
    ...
    Private Sub CreateParameters(ByVal dbCommandWrapper As DBCommandWrapper)
		...
		dbCommandWrapper.AddParameter("Computed1", DbType.Int32, ParameterDirection.Output, "Computed1", DataRowVersion.Current, Nothing)
		dbCommandWrapper.AddParameter("Computed2", DbType.AnsiString, 11, ParameterDirection.Output, true, 0, 0, "Computed2", DataRowVersion.Current, Nothing)
