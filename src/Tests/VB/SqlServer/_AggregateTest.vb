...
Public Class AggregateTestSchema
	...
	Public Shared IsActive As New SchemaItem("IsActive", DbType.Boolean, False, True, False, False, False, False)
...
Public MustInherit Class _AggregateTest
    ...
    Private Sub CreateParameters(ByVal dbCommandWrapper As DBCommandWrapper)
		...
		dbCommandWrapper.AddParameter("ts", DbType.Binary, 8, ParameterDirection.InputOutput, false, 0, 0, "ts", DataRowVersion.Current, Nothing)
