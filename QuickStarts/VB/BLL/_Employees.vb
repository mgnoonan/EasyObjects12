...
Public MustInherit Class _Employees
    ...
    Protected Overloads Overrides Function GetInsertCommand(commandType As CommandType) As DBCommandWrapper
		...
		Select Case commandType
			...
			Case CommandType.StoredProcedure
				...
				dbCommandWrapper.AddParameter("EmployeeID", DbType.Int32, 0, ParameterDirection.Output, true, 0, 0, "EmployeeID", DataRowVersion.Default, Convert.DBNull)
			...
			Case CommandType.Text
				...
				If Me.IdentityInsert Then
					dbCommandWrapper.AddInParameter("EmployeeID", DbType.Int32, "EmployeeID", DataRowVersion.Default)
				Else
					dbCommandWrapper.AddParameter("EmployeeID", DbType.Int32, 0, ParameterDirection.Output, true, 0, 0, "EmployeeID", DataRowVersion.Default, Convert.DBNull)
				End If
    ...
    Private Sub CreateParameters(ByVal dbCommandWrapper As DBCommandWrapper)
		...
		dbCommandWrapper.AddInParameter("LastName", DbType.String, "LastName", DataRowVersion.Current)
		dbCommandWrapper.AddInParameter("FirstName", DbType.String, "FirstName", DataRowVersion.Current)
		dbCommandWrapper.AddInParameter("Title", DbType.String, "Title", DataRowVersion.Current)
		dbCommandWrapper.AddInParameter("TitleOfCourtesy", DbType.String, "TitleOfCourtesy", DataRowVersion.Current)
		dbCommandWrapper.AddInParameter("BirthDate", DbType.DateTime, "BirthDate", DataRowVersion.Current)
		...
		dbCommandWrapper.AddInParameter("HomePhone", DbType.String, "HomePhone", DataRowVersion.Current)
		dbCommandWrapper.AddInParameter("Extension", DbType.String, "Extension", DataRowVersion.Current)
		dbCommandWrapper.AddInParameter("Photo", DbType.Binary, "Photo", DataRowVersion.Current)
		dbCommandWrapper.AddInParameter("Notes", DbType.String, "Notes", DataRowVersion.Current)
		dbCommandWrapper.AddInParameter("ReportsTo", DbType.Int32, "ReportsTo", DataRowVersion.Current)
		dbCommandWrapper.AddInParameter("PhotoPath", DbType.String, "PhotoPath", DataRowVersion.Current)
